module EventsHelper
	...
	def event_commands(selected)
		options_for_select([["Custom","custom"],["Copy","copy"], ["Snow Depth", "snow_depth"], ["Water Depth", "water_depth"], ["Ice Thickness", "ice_thickness"], ["Cull", "cull"], ["Julian Day", "julian"]], "#{selected}")
	end
